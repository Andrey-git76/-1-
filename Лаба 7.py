...
manager = Manager("Timokhin", 42, "Buy")
print(manager.get_info())
print(manager.manage_project("Work"))
...
technician = Technician("Andrey", 42, "G")
print(technician.get_info())
print(technician.perform_maintenance("L"))
...
tech_manager = TechManager("Andrey", 42, "mathematic analysses", "programs")
...
print(tech_manager.manage_project("Lyoha"))
print(tech_manager.perform_maintenance("DDer"))
